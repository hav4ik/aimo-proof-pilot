...
RUN_NAME="${OLMO_RUN_DIR_NAME:-prime_rl_opd_muon_colocated_dp2_testcsv_$(date -u +%Y%m%d_%H%M%S)}"
...
/usr/bin/python /app/train.py \
  ...
  --prime_opd_teacher_vllm_data_parallel_size 2 \
  ...
  --prime_vllm_data_parallel_size 2 \
