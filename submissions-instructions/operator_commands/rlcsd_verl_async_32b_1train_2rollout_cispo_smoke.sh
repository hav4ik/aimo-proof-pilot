...
PORT="${MASTER_PORT:-29597}"
RUN_NAME="rlcsd_verl_async_cispo_32b_1train_2rollout_smoke"
...
echo "CISPO/verl async smoke host=${HOST} node_rank=${NODE_RANK} master=${MASTER_HOST}:${PORT}"
